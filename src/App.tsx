...
export function App(){
  ...
  return <FileCard>
    ...
    <div className="hero"><img className="hero-art" src={previewArt} alt="Abstract overlapping market orbits, an illustration of two price paths"/><div className="hero-motif" aria-hidden="true"><span className="signal one"/><span className="signal two"/><span className="signal three"/><i/><b>≠</b></div><div className="hero-copy"><span className="eyebrow">STOCKLANA · EXPLAIN, DON'T TRADE</span><p>One token. Two pools. <em>Which price is real?</em></p></div></div>
    ...
    <Closing>Built for Stocklana · Read-only prototype · Live market quotes can be delayed or unavailable; no trades or wallet signatures.</Closing>
  </FileCard>
}
