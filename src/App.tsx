...
export function App(){
  ...
  return <FileCard>
    ...
    <Closing>DoubleTake · Built for the Stocklana hackathon · Read-only prototype · Live market quotes can be delayed or unavailable; no trades or wallet signatures.</Closing>
  </FileCard>
}
